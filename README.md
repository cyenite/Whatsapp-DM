...
You can download by clicking [here](https://github.com/aaronkip/Whatsapp-DM/raw/master/apk/WhatsApp_Direct_Message.apk) :-)

### Install and contribute

```sh
$ git clone https://github.com/aaronkip/Whatsapp-DM.git
```
